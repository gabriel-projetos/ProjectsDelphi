...
begin
  ...
  //Memo1.Lines.Add('Nome: ' + Comanda.FNomeProduto + ' Preço: ' + FloatToSTR(Comanda.FPrecoProduto) + ' Quantidade :' + IntToSTR(Comanda.FQuantidadeProduto));
end;

...
type
  TCarro = class
    ...
    procedure Acelera(const Value: double);
    procedure Freia(const Value: double);
...
procedure TCarro.Acelera(const Value: double);
begin
  FVelocidadeAtual := FVelocidadeAtual + 1;
end;

procedure TCarro.Freia(const Value: double);
begin
  FVelocidadeAtual := FVelocidadeAtual - 1;
end;
...
begin
  FVelocidadeAtual := FVelocidadeAtual + value;
end;
